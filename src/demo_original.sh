...
#--pre_train [pre-trained EDSR_x2 model dir]

python main.py --model EDSR --scale 4 --save edsrtencent_x4 --n_resblocks 16 --n_feats 64  --res_scale 0.1 --reset  --dir_data /home/dew/Programming/datasets/ --batch_size 3 --ext sep_reset
